        ...
        $('#success').click(function(e) {
            $.post("/attendance", {
                ...
                function(data) {
                    ...
                    $('#timeStatus').html(data.timeStatus);
                    $('#attendance_date').html(_date);
                    $('#attendance_time').html(_time);
                    $('#employee_photo').attr('src', `uploads/02e74f10e0327ad868d138f2b4fdd6f0.png`);
                    $('#employee_position').html('Performer');
                    $('#employee_name').html("Lim, Mikhaela Janna  Jimenea");
                    $('#employee_id').html("0027");
