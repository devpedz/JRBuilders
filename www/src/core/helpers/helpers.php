...
function enroll1($fmd1)
{
    ...
    $pre_reg_fmd_array = ["index_finger" => $index_finger, "middle_finger" => ''];
...
function verify1($currentFinger, $index_finger, $middle_finger)
{

    $pre_reg_fmd = $currentFinger;
